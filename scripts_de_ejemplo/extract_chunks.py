...
#presentes en el directorio ./raw_texts, en el caso de que hubiera ocho directorios
total = []
for n in range(1,9):
    n_as_str = str(n)
    res = chunk_extractor.process_files(n_as_str, gramatical_filter.process_pos_sequence_by_dep_tag, "obl", ["SCONJ","DET", "NOUN"])
    total = total + res
